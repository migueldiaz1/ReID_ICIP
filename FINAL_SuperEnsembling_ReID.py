...
USE_MODEL_PAIR = 'baseline'         # opciones: 'resnet50', 'seresnet50', 'resnet101', 'seresnet50_IBN'. 'resnet_50_101 NOTA: AÑADE MODELOS FACIL ABAJO
USE_DATASET_SET = 'original'   # opciones: 'original_sr_st', 'augmv1_augmv2', 'original_3x'
...
TRANSFER_ROOT = "/home/mdb/reid-strong-baseline/TRANSFER_Learning_SR_ensembling2/"
...
MODEL_CONFIGS = {
    ...
    'resnet101_single': {
        'models': ['resnet101'],
        'weights': {
            'resnet101': '/home/mdb/reid-strong-baseline/configs/resnet101.pth'
            }
    }
}
...
if USE_MODEL_TYPE == 'PaT':
    TRANSFER_ROOT = "/home/mdb/DL_Lab3/TRANSFER_PaT/"
    TRAIN_SCRIPT = "/home/mdb/DL_Lab3/Part-Aware-Transformer/train.py"
    UPDATE_SCRIPT = "/home/mdb/DL_Lab3/Part-Aware-Transformer/update.py"
else:
    ...
    for model_name in MODEL_NAMES:
        for pair_name, paths in DATASET_PAIRS.items():
            ...
            if training_on_UAM:
                ...
                uam_yaml['SOLVER']['MAX_EPOCHS'] = 60  #60       # Subimos un poco para datasets pequeños
            ...
            rivas_yaml['SOLVER']['BASE_LR'] = 0.0001
            rivas_yaml['SOLVER']['MAX_EPOCHS'] = 60
