...
USE_MODEL_PAIR = 'seresnet50_IBN'         # opciones: 'resnet50', 'seresnet50', 'resnet101', 'seresnet50_IBN'. 'resnet_50_101
...
BASE_YAML_TEMPLATE = {
    'MODEL': {
        ...
        'IF_LABELSMOOTH': 'on',
        'IF_WITH_CENTER': 'yes',            # Center loss NO compatible con quadruplet en tu código
    },
    'INPUT': {
        'SIZE_TRAIN': [256, 256],
        'SIZE_TEST': [256, 256],
    ...
    'SOLVER': {
        ...
        'BASE_LR': 0.00035,
        'CENTER_LR': 0.5,
        'CENTER_LOSS_WEIGHT': 0.0005,      # Aunque no se usará, no es necesario borrarlo
        'IMS_PER_BATCH': 64,
    ...
    for model_name in MODEL_NAMES:
        for pair_name, paths in DATASET_PAIRS.items():
            ...
            if class_name == "Rubish":
                ...
                uam_yaml['SOLVER']['IMS_PER_BATCH'] = 128                    # Mod el 4 de mayo, de 64 a 128
            ...
            uam_yaml['SOLVER']['MAX_EPOCHS'] = 30 #60       # Subimos un poco para datasets pequeños
            uam_yaml['INPUT']['RE_PROB'] = 0.5           # Más augmentation
            ...
            if class_name == "Rubish":
                ...
                rivas_yaml['SOLVER']['BASE_LR'] = 0.00035  
