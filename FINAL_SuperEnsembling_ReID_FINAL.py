...
USE_MODEL_PAIR = 'best'         # opciones: 'resnet50', 'seresnet50', 'resnet101', 'seresnet50_IBN'. 'resnet_50_101 NOTA: AÑADE MODELOS FACIL ABAJO
...
MODEL_CONFIGS = {
    ...
    'best': {
        'models': ['resnet101', 'resnet50_ibn_a', 'resnet50'],
        'weights': {
