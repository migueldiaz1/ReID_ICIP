...
def main():
    ...
    clase = os.path.basename(os.path.dirname(os.path.dirname(config_path)))  # 'Crosswalks'
    output_feat_dir = cfg.OUTPUT_DIR
    if output_feat_dir is None or not os.path.isdir(output_feat_dir):
        raise ValueError(f"Ruta OUTPUT_DIR no válida: {output_feat_dir}")

    #print(f"Guardado en: /home/mdb/reid-strong-baseline/TRANSFER_Learning_SR_ensembling/{clase}/UAM")
